...
const Settings: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">{t('adminDashboard.settings', 'Configuración')}</h1>
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-gray-700 font-medium mb-1">Nombre de la Plataforma</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-1">Email de Contacto</label>
            <input
              type="email"
              className="w-full border border-gray-300 rounded-lg px-3 py-2"
              value={contactEmail}
