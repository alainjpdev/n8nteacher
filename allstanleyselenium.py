...
# Function to scrape data from a given URL using Selenium
def scrape_data_from_url(url):
    driver.get(url)
    soup = BeautifulSoup(driver.page_source, 'html.parser')
    
    # Attempt to find the div using both class names
...
driver_path =  '/Users/wavesmanagement/Downloads/chromedriver-mac-arm64/chromedriver'  # Update this path to your ChromeDriver
...
output_csv_path = 'all_stanley_output.csv'
...
print(f"Scraped data has been saved to {output_csv_path}")
